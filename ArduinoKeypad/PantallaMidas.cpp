...
void PantallaMidas::configura() {
	...
	// según indicaciones recogidas de su manual
	delay(20); // Espera 20 ms para asegurar que la alimentación se estabilice
	busDatos4Bits(3);
	pulsoE1();
	pulsoE2();
	...
	// Envía la orden Function set con los bits:
